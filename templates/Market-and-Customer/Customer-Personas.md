...
> For named customer accounts, see Reference Customers and Champions.
...
> Copy this block for each persona. A complete use case typically has 1–3 personas.
> Fill all fields for primary personas. Secondary personas may use a lighter version — see Section 2.2.
...
> Add personas by copying the full or lightweight template above.
> Organize each persona under its primary use case as a subsection (e.g., ### 2.3 [Persona Name] — [Use Case]).
